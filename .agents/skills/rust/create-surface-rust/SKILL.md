...
**This skill consolidates rules from:** `module_logic_validator`, `enforce-1-struct-per-file`, `trait-consolidation`, and AES406 surface role checks — applied specifically to the surface layer.
