...
**This skill consolidates rules from:** `enforce-1-struct-per-file`, `trait-consolidation`, `method_classifier`, and `create-capabilities`/`create-infrastructure`/`create-agent` — applied specifically to the taxonomy layer.
