...
**This skill consolidates rules from:** `enforce-1-class-per-file`, `method_classifier`, and `create-capabilities`/`create-infrastructure`/`create-agent` — applied specifically to the taxonomy layer.
