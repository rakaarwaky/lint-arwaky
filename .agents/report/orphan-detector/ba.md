...
**Recommendation:** Amend AES503 to: *"Capability files must be instantiated or imported by orchestrators or wired in root containers."*
...
- An architecture documentation error (Agent *can* use Utility), or
...
The FRD states the goal is *"preventing codebase bloat and keeping the system maintainable"* but lacks:
...
*Document under review: `orphan-detector` v1.10.106 — FRD, ARCHITECTURE.md, and source implementation*
*Date: July 21, 2026*
