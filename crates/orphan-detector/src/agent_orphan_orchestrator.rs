...
impl Default for ArchOrphanAnalyzer {
    fn default() -> Self {
        Self::new(
            ...
            Arc::new(crate::capabilities_orphan_agent_analyzer::AgentOrphanAnalyzer::new(Arc::new(crate::infrastructure_file_cache::OrphanFileCache::new()))),
            Arc::new(crate::capabilities_orphan_surfaces_analyzer::SurfacesOrphanAnalyzer::new(Arc::new(crate::capabilities_orphan_filename_extractor::OrphanFilenameExtractor::new()), Arc::new(crate::infrastructure_file_cache::OrphanFileCache::new()))),
        )
    }
}
