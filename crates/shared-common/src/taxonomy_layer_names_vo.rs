...
use orphan_detector::taxonomy_layer_names_constant::LAYER_AGENT;
use orphan_detector::taxonomy_layer_names_constant::LAYER_CAPABILITIES;
use orphan_detector::taxonomy_layer_names_constant::LAYER_CONTRACT;
use orphan_detector::taxonomy_layer_names_constant::LAYER_GLOBAL;
use orphan_detector::taxonomy_layer_names_constant::LAYER_INFRASTRUCTURE;
use orphan_detector::taxonomy_layer_names_constant::LAYER_ROOT;
use orphan_detector::taxonomy_layer_names_constant::LAYER_SURFACES;
use orphan_detector::taxonomy_layer_names_constant::LAYER_TAXONOMY;
