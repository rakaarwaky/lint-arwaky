...
pub struct LanguageContainer {
    javascript_flow_port:
        Arc<dyn shared::language_adapters::contract_flow_port::IJavascriptFlowPort>,
    naming_provider_port:
        Arc<dyn shared::language_adapters::contract_naming_port::INamingProviderPort>,
    javascript_scope_port:
        Arc<dyn shared::language_adapters::contract_scope_port::IJavascriptScopePort>,
    semantic_tracer_port:
        Arc<dyn shared::language_adapters::contract_semantic_tracer_port::ISemanticTracerPort>,
    naming_variant_port:
        Arc<dyn shared::language_adapters::contract_variant_port::INamingVariantPort>,
}

impl LanguageContainer {
    pub fn new() -> Self {
        let variant: Arc<dyn shared::language_adapters::contract_variant_port::INamingVariantPort> =
            Arc::new(crate::infrastructure_py_variants::PythonNamingVariantProvider::new());
        Self {
            ...
            semantic_tracer_port: Arc::new(crate::infrastructure_py_ast_tracer::PythonTracer::new(
    ...
    pub fn javascript_flow_port(
        &self,
    ) -> Arc<dyn shared::language_adapters::contract_flow_port::IJavascriptFlowPort> {
        self.javascript_flow_port.clone()
    }

    pub fn naming_provider_port(
        &self,
    ) -> Arc<dyn shared::language_adapters::contract_naming_port::INamingProviderPort> {
        self.naming_provider_port.clone()
    }

    pub fn javascript_scope_port(
        &self,
    ) -> Arc<dyn shared::language_adapters::contract_scope_port::IJavascriptScopePort> {
        self.javascript_scope_port.clone()
    }

    pub fn semantic_tracer_port(
        &self,
    ) -> Arc<dyn shared::language_adapters::contract_semantic_tracer_port::ISemanticTracerPort>
    {
