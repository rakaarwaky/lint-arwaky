...
use config_system_lint_arwaky::utility_config_parser::parse_config_yaml;
...
fn bench_workspace_detect(c: &mut Criterion) {
    ...
    let fs_arc: std::sync::Arc<dyn shared::filesystem::contract_filesystem_io_protocol::IFileSystemIOProtocol> =
