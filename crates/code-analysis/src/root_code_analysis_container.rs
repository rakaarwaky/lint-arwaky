...
pub struct CodeAnalysisCheckerContainerParts {
...
impl CodeAnalysisCheckerContainer {
    pub fn new(analyzer: Arc<dyn IAnalyzer>) -> Self {
        Self::new_with_parts(
            analyzer,
            CodeAnalysisCheckerContainerParts {
                capabilities_role_checker: Arc::new(PlaceholderCapabilitiesRoleChecker),
            },
        )
    }

    pub fn new_with_parts(analyzer: Arc<dyn IAnalyzer>, parts: CodeAnalysisCheckerContainerParts) -> Self {
        Self {
            analyzer,
...
impl shared::file_system::contract_system_port::IFileSystemPort for NullFileSystem {
    async fn walk(&self, _path: &FilePath, _ignored_patterns: Option<&shared::common::taxonomy_common_vo::PatternList>) -> shared::source_parsing::taxonomy_paths_vo::FilePathList {
    ...
    async fn glob(&self, _pattern: &shared::common::taxonomy_layer_vo::Identity) -> shared::source_parsing::taxonomy_paths_vo::FilePathList {
        shared::source_parsing::taxonomy_paths_vo::FilePathList::new(vec![])
    }
