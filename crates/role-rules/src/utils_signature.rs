// PURPOSE: Signature analysis utilities for contract role audits (AES402)
//
// These pure functions implement signature parsers used by the contract
// role checker. They are extracted here so they can be unit-tested directly
// without needing to construct a ContractRoleChecker or feed it a full
// SourceContentVO.
...
pub fn regex_lite_match_whole_token(haystack: &str, needle: &str) -> bool {
    if needle.is_empty() {
        return false;
    }
