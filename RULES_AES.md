...
| 8   | `agent(orchestrator)`                           | taxonomy, contract                               | taxonomy, contract(aggregate)                         | surface\_, infrastructure, capabilities, root                                                     |
...
**Taxonomy Relaxed Suffixes (`_util`, `_helper`):**
Files with `_util` or `_helper` suffix are taxonomy files with relaxed rules:
...
| `taxonomy`       | strict   | `_vo`, `_entity`, `_error`, `_event`, `_constant`, `_util`, `_helper`                                                                                                                                                                                                                                                                                                                                                                                                | N/A                                                                      |
