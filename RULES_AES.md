...
| AES0305 | Agent Role          | HIGH     | `_container` / `_orchestrator` / `_coordinator` / `_manager` | Agent file too large (>300 lines), non-stateless execution, low-level policy imports, or `any` type annotations.                        |
