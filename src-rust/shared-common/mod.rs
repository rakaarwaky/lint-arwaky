...
pub use taxonomy_registered_vo::AdapterRegistered;
...
pub use taxonomy_applied_event::FixApplied;
pub mod taxonomy_completed_event;
pub use taxonomy_completed_event::ScanCompleted;
pub mod taxonomy_failed_event;
pub use taxonomy_failed_event::ScanFailed;
