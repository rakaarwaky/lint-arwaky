...
pub const AES009_MANDATORY_CLASS_DEFINITION: &str =
    "AES009 MANDATORY_CLASS_DEFINITION: File is missing a class, dataclass, or Protocol definition.\n\
...
pub const AES021_COORDINATES_MULTIPLE: &str =
    "Coordinator must manage multiple orchestrators.";
pub const AES021_NO_DOMAIN_LOGIC: &str =
    "Complex domain logic detected in a passive layer/role.";
pub const AES021_LAZY_EAGER_INIT: &str =
    "Complex initialization logic found in Container.";
pub const AES021_MUST_IMPLEMENT_CONTRACT: &str =
    "Class must implement ServiceContainerAggregate.";
pub const AES024_ANY_TYPE: &str =
...
pub fn aes006_primitive_usage(primitive: &str) -> String {
    format!("AES006 PRIMITIVE_USAGE: Direct primitive '{}' in taxonomy.", primitive)
}
