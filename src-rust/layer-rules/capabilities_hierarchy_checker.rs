...
use crate::shared_common::taxonomy_violationrs_constant::{
    aes018_hierarchy_violation, aes019_passive_viotation_details,
};
...
impl SurfaceHierarchyChecker {
    ...
    pub fn check_surface_hierarchy(
        ...
        for f in files {
            ...
            if !is_wired(f) {
                let desc = aes018_hierarchy_violation(&f.to_string());
    ...
    fn _report_aes019(&self, f: &FilePath, violations: Vec<String>, results: &mut LintResultList) {
        ...
        results.push(LintResult {
            ...
            message: LintMessage::new(aes019_passive_viotation_details(&f.to_string(), &detail)),
            source: Some(AdapterName::raw("surface_hierarchy")),
            severity: Severity::HIGH,
            enclosing_scope: None,
            related_locations: LocationList::new(),
